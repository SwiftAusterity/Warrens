...
namespace NetMud.DataAccess.Cache
{
    ...
    /// </summary>
    [Serializable]
    public class LuceneDataCacheKey : ICacheKey
    {
        [JsonIgnore]
        [ScriptIgnore]
        public CacheType CacheType => CacheType.LuceneData;
        ...
        [JsonConstructor]
        public LuceneDataCacheKey(Type objectType, string birthMark)
        {
        ...
        public LuceneDataCacheKey(ILuceneData data)
        {
