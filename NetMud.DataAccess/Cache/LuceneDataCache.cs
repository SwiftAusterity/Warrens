...
namespace NetMud.DataAccess.Cache
{
    ...
    /// </summary>
    public static class LuceneDataCache
    {
        private static readonly CacheAccessor BackingCache = new CacheAccessor(CacheType.LuceneData);

        /// <summary>
        /// Adds a single entity into the cache
        /// </summary>
        /// <param name="objectToCache">the entity to cache</param>
        public static void Add<T>(T objectToCache) where T : ILuceneData
        {
            BackingCache.Add(objectToCache, new LuceneDataCacheKey(objectToCache));
        }
        ...
        public static IEnumerable<T> GetMany<T>(IEnumerable<LuceneDataCacheKey> keys) where T : ILuceneData
        {
        ...
        public static T Get<T>(LuceneDataCacheKey key) where T : ILuceneData
        {
        ...
        /// <param name="key">the key it was cached with</param>
        /// <returns>the entity requested</returns>
        public static object Get(LuceneDataCacheKey key)
        {
        ...
        /// <returns>the entity requested</returns>
        public static T Get<T>(string uniqueKey) where T : ILuceneData
        {
            LuceneDataCacheKey key = new LuceneDataCacheKey(typeof(T), uniqueKey);
        ...
        public static void Remove(LuceneDataCacheKey key)
        {
        ...
        public static bool Exists(LuceneDataCacheKey key)
        {
