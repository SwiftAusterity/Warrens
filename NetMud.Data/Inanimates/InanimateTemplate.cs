...
namespace NetMud.Data.Inanimates
{
    ...
    public class InanimateTemplate : EntityTemplatePartial, IInanimateTemplate
    {
        ...
        /// </summary>
        [Display(Name = "Random Debris", Description = "Is this item part of the randomized debris set for its world? Base world debris is used for new player farms.")]
        [UIHint("Boolean")]
        public bool RandomDebris { get; set; }
        ...
        public override IDictionary<string, string> SignificantDetails()
        {
            ...
            returnList.Add("Debris", RandomDebris.ToString());
        ...
        public override object Clone()
        {
            ...
            HashSet<IUse> uses = new HashSet<IUse>();
            foreach (IUse use in Uses)
                uses.Add((IUse)use.Clone());
