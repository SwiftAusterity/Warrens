...
namespace NetMud.Controllers.GameAdmin
{
    ...
    public class CelestialsController : Controller
    {
        ...
        public ActionResult Add(AddEditCelestialViewModel vModel)
        {
            string message = string.Empty;
            ApplicationUser authedUser = UserManager.FindById(User.Identity.GetUserId());
            Celestial newObj = new Celestial
            {
                Name = vModel.DataObject.Name,
                Apogee = vModel.DataObject.Apogee,
                Perigree = vModel.DataObject.Perigree,
                Luminosity = vModel.DataObject.Luminosity,
                Velocity = vModel.DataObject.Velocity,
                OrientationType = vModel.DataObject.OrientationType,
        ...
        {
            string message = string.Empty;
            AddEditCelestialViewModel vModel = new AddEditCelestialViewModel(-1)
            {
                authedUser = UserManager.FindById(User.Identity.GetUserId())
            };
