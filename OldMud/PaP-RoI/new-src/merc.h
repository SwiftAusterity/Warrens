...
#define RANK_PLAYTESTER	2
#define RANK_STAFF	3
#define RANK_ASSISTANT	4
#define RANK_BOSS	5
...
struct	skill_type
{
    ...
    int 	stree [ MAX_SKILL_TREE ];	/* Levels needed to learn */
    int 	races [ MAX_RACE ];	/* Levels needed to learn */
    SPELL_FUN *	spell_fun;  		/* Spell pointer (for spells) */
    int *	pgsn;	  		/* Pointer to associated gsn */
    int         slot;			/* For object loading */
    int 	target;			/* Legal targets */
    int 	wait;		   	/* Waiting time after use */
    int 	stamina;   		/* Stamina cost */
    int 	mana;			/* Mana cost */
    int		min_range;
    int		max_range;
    int 	position;		/* Position for user */
    bool	arms;
    bool	legs;
    bool	voice;
    bool	movement;
    int 	group_size;		/* Number of people req */
    int		dispel;			/* Dispel rating */
    char *	affect_noun;	 	/* Damage message */
    char *	list_color;	 	/* Slist color code */
    char *	occupied;  		/* Busy-doing message */
...
struct gskill_type
{
    ...
    int         casters;                   /* Casters needed by class    */
};
 ...
 */
extern  int     gsn_example; /* An example, obviously */
