...
struct	cmd_type	cmd_table	[ ] =
{
    ...
    { "touch",		do_touch,	POS_FIGHTING,	 0,  LOG_NORMAL	},
 ...
 /* { "assasinate",    do_assasinate,   POS_STANDING,   30,  LOG_ALWAYS },*/
    ...
    { "recall",         do_lowrecall,   POS_FIGHTING,    0,  LOG_NORMAL },
    ...
    { "molotov",	do_molotov,	POS_RESTING,	 0,  LOG_ALWAYS },
    { "blasto",         do_blasto,	POS_RESTING,	 0,  LOG_ALWAYS },
    { "timebomb",       do_timebomb,	POS_STANDING,	 0,  LOG_ALWAYS },
    { "pipebomb",	do_pipebomb,	POS_RESTING,	 0,  LOG_ALWAYS },
    { "cherrybomb",	do_cherrybomb,	POS_RESTING,	 0,  LOG_ALWAYS },
    { "teargas",	do_teargas,	POS_RESTING,	 0,  LOG_ALWAYS },
    { "chemicalbomb",	do_chemicalbomb,POS_RESTING,	 0,  LOG_ALWAYS },
/*    { "engrave",	do_engrave,	POS_RESTING,	 0,  LOG_NORMAL },*/
    { "scribe",         do_scribe,      POS_RESTING,     0,  LOG_ALWAYS },
    { "gravebind",	do_gravebind,	POS_RESTING,	 0,  LOG_NORMAL },
    { "mummify",	do_mummify,	POS_RESTING,	 0,  LOG_NORMAL },
    { "flamehand",	do_flamehand,	POS_RESTING,	 0,  LOG_NORMAL },
    { "quiverpalm",	do_quiverpalm,	POS_RESTING,	 0,  LOG_NORMAL },
    { "frosthand",	do_frosthand,	POS_RESTING,	 0,  LOG_NORMAL },
    { "chaoshand",	do_chaoshand,	POS_RESTING,	 0,  LOG_NORMAL },
    { "shockhand",	do_shockhand,	POS_RESTING,	 0,  LOG_NORMAL },
    { "colorhand",	do_colorhand,	POS_RESTING,	 0,  LOG_NORMAL },
    { "darkhand",	do_darkhand,	POS_RESTING,	 0,  LOG_NORMAL },
   /* Switch activation commands */
    ...
    { "facestrike",	do_facestrike,	POS_FIGHTING,	 0,  LOG_NORMAL },
    ...
    { "masterstrike",	do_masterstrike,POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "kick",		do_kick,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "charge",		do_charge,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "parlay",		do_parlay,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "wire",		do_wire,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "torture",	do_torture,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "wrack",		do_wrack,	POS_STANDING,	 0,  LOG_NORMAL	},
    { "gaze",		do_gaze,	POS_STANDING,	 0,  LOG_ALWAYS	},
    { "whirl",		do_whirl,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    ...
    { "slam",   	do_slam,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "grapple",   	do_grapple,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "black star",	do_black_star,	POS_FIGHTING,	 0,  LOG_NORMAL },
    ...
    { "eyestrike",	do_eyestrike,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "neckstrike",	do_neckstrike,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "anklestrike",	do_anklestrike,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "shriek",		do_shriek,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "gust of wind",	do_gust_of_wind,POS_FIGHTING,	 0,  LOG_ALWAYS },
    { "snatch",		do_snatch,	POS_FIGHTING,	 0,  LOG_ALWAYS },
    ...
    { "martyrize",      do_martyrize,   POS_FIGHTING,    0,  LOG_NORMAL },
    { "multiburst",	do_multiburst,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "bite",		do_bite,	POS_FIGHTING,	 0,  LOG_NORMAL },
    { "terrorize",	do_terrorize,	POS_FIGHTING,	 0,  LOG_NORMAL },
    ...
    { "traproom",	do_traproom,    POS_STANDING,    0,  LOG_ALWAYS },
    ...
    { "superform",	do_superform,	POS_STANDING,	0, LOG_NORMAL },
