...
bool medit_class( CHAR_DATA *ch, char *argument )
{
    ...
    if ( argument[0] == '\0' )
    {
	editor_send_to_char(C_DEFAULT, "Syntax: class [mobs class]\n\r", ch );
	return FALSE;
    }
    ...
    editor_send_to_char(C_DEFAULT, "Incorrect class number.\n\r", ch );
    return FALSE;
}
...
editor_send_to_char( C_DEFAULT, buf, ch );
sprintf( buf, "DEF [%3d]\n\r", pSpell->skill_level[14]);
editor_send_to_char( C_DEFAULT, buf, ch );
sprintf( buf, "TER [%3d]\n\r", pSpell->skill_level[15]);
editor_send_to_char( C_DEFAULT, buf, ch );
return FALSE;
}
...
bool spedit_dispelable( CHAR_DATA *ch, char *argument )
{
  ...
  if ( pSpell->dispelable )
    ...
    if (pSpell->dispelable )
	editor_send_to_char(C_DEFAULT, "Spell switched to dispelable.", ch);
    else
	editor_send_to_char(C_DEFAULT, "Spell switched to non dispelable.", ch);
...
bool spedit_wait( CHAR_DATA *ch, char *argument )
{
  ...
  if ( argument[0] == '\0' || !is_number( argument ) )
  {
    editor_send_to_char(AT_WHITE, "Syntax:  &Bwait [number]\n\r", ch );
    return FALSE;
  }
  ...
  editor_send_to_char(AT_WHITE, "Mana cost set.\n\r", ch);
  return TRUE;
}
...
bool spedit_damage_msg ( CHAR_DATA *ch, char *argument )
{
  ...
  if ( argument[0] == '\0' )
  {
    editor_send_to_char(C_DEFAULT, "Syntax:  1 [string]\n\r", ch );
    return FALSE;
  }
  ...
  editor_send_to_char(C_DEFAULT, "Spell damage message set.\n\r", ch);
  return TRUE;
...
bool spedit_spell_ends( CHAR_DATA *ch, char *argument )
{
  ...
  if ( argument[0] == '\0' )
  {
    editor_send_to_char(C_DEFAULT, "Syntax:  2 [string]\n\r", ch );
    return FALSE;
  }
  ...
  editor_send_to_char(C_DEFAULT, "Spell wear off message set.\n\r", ch);
  return TRUE;
...
bool spedit_spell_ends_room( CHAR_DATA *ch, char *argument )
{
  ...
  if ( argument[0] == '\0' )
  {
    editor_send_to_char(C_DEFAULT, "Syntax:  3 [string]\n\r", ch );
    return FALSE;
  }
...
bool spedit_min( CHAR_DATA *ch, char *argument )
{
  ...
  {
    editor_send_to_char(C_DEFAULT, "Syntax:  min [class] [level]\n\r", ch );
    return FALSE;
  }
  ...
  editor_send_to_char( AT_RED, "Invalide class.\n\r", ch );
  return FALSE;
...
bool spedit_mana( CHAR_DATA *ch, char *argument )
{
  ...
  if ( argument[0] == '\0' || !is_number( argument ) )
  {
    editor_send_to_char(AT_WHITE, "&BSyntax:  mana [number]\n\r", ch );
    return FALSE;
  }
