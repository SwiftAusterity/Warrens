...
int			gsn_shroud;
int			gsn_disguise;
int			gsn_snake_stance;
int			gsn_dragon_stance;
int			gsn_tiger_stance;
int			gsn_bull_stance;
int			gsn_panther_stance;
int			gsn_crane_stance;
int			gsn_sparrow_stance;
int			gsn_monkey_stance;
int			gsn_peek;
int			gsn_pick_lock;
int                     gsn_punch;
int			gsn_jab_punch;
...
int			gsn_pain_tolerance;
int			gsn_armor_knowledge;
int			gsn_place_force;
int			gsn_blade_clash;
int			gsn_weapons_mastery;
int			gsn_desperation;
int			gsn_ripotse;
int			gsn_fisticuffs;
int			gsn_redirect;
int			gsn_parlay;
int                     gsn_superior_damage;
int                     gsn_enhanced_hit;
int			gsn_flury;
int			gsn_masterstrike;
int			gsn_kick;
int			gsn_charge;
int			gsn_gaze;
int			gsn_torture;
...
int			gsn_crane_wing;
int			gsn_panther_paw;
int			gsn_panther_tail;
int			gsn_panther_scratch;
int			gsn_dragon_roar;
int			gsn_dragon_blast;
int			gsn_dragon_grab;
int			gsn_snake_fang;
int			gsn_snake_bite;
int			gsn_snake_rush;
int			gsn_bull_rush;
int			gsn_sparrow_flower;
int			gsn_sparrow_song;
int			gsn_sparrow_wing;
int			gsn_sparrow_hop;
int			gsn_sparrow_claw;
int			gsn_sparrow_smash;
int			gsn_monkey_headbutt;
int			gsn_blackbelt;
int			gsn_ironfist;
int			gsn_globedark;
int			gsn_drowfire;
